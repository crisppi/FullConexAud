...
<div class="container">
    <nav class="navbar navbar-light bg-light">
        <div class="container py-2">
            ...
            <h4 class="page-title">Relação Internação</h4>
        </div>
    </nav>
        ...
        <div class="container py-2">
            ...
            <form class="formulario visible" action="" id="select-internacao-form" method="GET">
                ...
                <div class="form-group col-sm-1" style="margin:0px 0px 10px 30px">
                    <button type="submit" class="btn btn-primary btn-int-pesq"><span class="material-icons">
                            person_search
                        </span></button>
                </div>
        </div>
    ...
    $qtdIntItens1 = $QtdTotalInt->QtdInternacaoList($where);
                ...
                <tr>
                    ...
                    <td class="action">
                        ...
                        <?php if ($pesqInternado == "s") { ?><form class="d-inline-block delete-form" action="edit_alta.php" method="get">
                                ...
                                <button type="hidden" style="margin-left:3px; font-size: 12px; background:transparent; font-weight: bold; border-color:transparent; color:green" class="delete-btn"><i class=" d-inline-block bi bi-door-open"> ALTA</i></button>
                            </form>
                        <?php }; ?>
                    </td>
                </tr>
