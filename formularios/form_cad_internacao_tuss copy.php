<div id="container-tuss" style="display:none; margin:5px">
    <hr>
    <h6>Cadastrar dados do código TUSS</h7>
        ...
        <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <input type="hidden" class="form-control" id="fk_int_tuss" name="fk_int_tuss" value="<?= $ultimoReg ?>">
            ...
            <div id="div-TUSS2" style="display:none" class="form-group row">
                ...
                <input type="hidden" class="form-control" id="fk_int_tuss2" name="fk_int_tuss2"
                    value="<?= $ultimoReg ?>">
            ...
            <div id="div-TUSS3" style="display:none" class="form-group row">
                ...
                <input type="hidden" class="form-control" id="fk_int_tuss3" name="fk_int_tuss3"
                    value="<?= $ultimoReg ?>">
                <div class="form-group col-sm-3">
            ...
            <div id="div-TUSS4" style="display:none" class="form-group row">
                ...
                <input type="hidden" class="form-control" id="fk_int_tuss4" name="fk_int_tuss4"
                    value="<?= $ultimoReg ?>">
                <div class="form-group col-sm-3">
            ...
            <div id="div-TUSS5" style="display:none" class="form-group row">
                ...
                <input type="hidden" class="form-control" id="fk_int_tuss5" name="fk_int_tuss5"
                    value="<?= $ultimoReg ?>">
                <div class="form-group col-sm-3">
            ...
            <div id="div-TUSS6" style="display:none" class="form-group row">
                ...
                <input type="hidden" class="form-control" id="fk_int_tuss6" name="fk_int_tuss6"
                    value="<?= $ultimoReg ?>">
                <div class="form-group col-sm-3">
