...
$("#myForm").submit(function(event) {
    ...
    console.log("Request method:", request_method);

    var fk_int_capeante_js = document.querySelector("#fk_int_capeante");
    console.log("fk_int_capeante_js value:", fk_int_capeante_js.value);
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if (3 < 4) {
                console.log("Internação cadastrada com sucesso.");
                ...
                console.log("Current RegInt:", currentRegInt, " | New RegInt:", newRegInt);
                ...
                console.log("Novo Valor Internação:", novoValorInternacao);
                ...
                console.log("Paciente já possui internação ativa.");
...
document.getElementById('fk_patologia2').addEventListener('change', function() {
    ...
    // Log para depuração
    // console.log("JSON Antecedentes Gerado:", JSON.stringify(jsonAntecedentes));
});
</script>
