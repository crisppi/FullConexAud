<div id="container-gestao" style="display:none; margin:5px">
    <h6 class="page-title">Cadastrar o dados de gestão</h6>
    <input type="hidden" name="typeGes" value="createGes">
    <div class="form-group row">

        <div>
            <input type="hidden" class="form-control" id="fk_internacao_ges" name="fk_internacao_ges"
        ...
        <div style="display:none" id="div_rel_alto_custo">
            ...
            <textarea type="textarea" rows="10" class="form-control" id="rel_alto_custo_ges" name="rel_alto_custo_ges"
                placeholder="Relatório da gestão alto custo"></textarea>
        </div>
        <div class="form-group col-sm-2">
        ...
        <div style="display:none" id="div_rel_home_care">
            ...
            <textarea type="textarea" rows="10" class="form-control" id="rel_home_care" name="rel_home_care"
                placeholder="Relatório Home care"></textarea>
        </div>
        <div class="form-group col-sm-2">
        ...
        <div style="display:none" id="div_rel_opme">
            ...
            <textarea type="textarea" rows="10" class="form-control" id="rel_opme_ges" name="rel_opme_ges"
                placeholder="Relatório da gestão alto custo"></textarea>
        </div>
        <div class="form-group col-sm-2">
        ...
        <div style="display:none" id="div_rel_desospitalizacao">
            ...
            <textarea type="textarea" rows="10" class="form-control" id="rel_desospitalizacao_ges"
                name="rel_desospitalizacao_ges" placeholder="Relatório Desospitalização"></textarea>
        </div>
        <div class="form-group col-sm-2">
        ...
        <div style="display:none" id="div_rel_evento">
            ...
            <textarea type="textarea" rows="10" class="form-control" id="rel_evento_averso_ges"
                name="rel_evento_averso_ges" placeholder="Relatório de Evento Adverso"></textarea>
        </div>
    </div>
    <br>
</div>
