...
<div id="main-container" class="container">
    <div class="row">
        <!-- <h4 class="page-title">Cadastrar Hospital por Usuário</h4>
        ...
        <form class="formulario-borderless" action="<?= $BASE_URL ?>process_hospitalUser.php" id="add-movie-form"
            ...
            <div class="form-group col-sm-3">
                ...
                <select class="form-control" id="fk_hospital_user" name="fk_hospital_user" required>
                    <option value="<?= $hospital["nome_hosp"] ?? "Selecione o Hospital" ?>">Selecione o Hospital
                    </option>
            ...
            <br>
            <button type="submit" class="btn btn-primary"><i style="font-size: 1rem;margin-right:5px;" name="type"
