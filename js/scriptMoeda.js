...
inputMed.addEventListener("blur", function() {
    ...
    // PEGAR DADOS DO INPUT - valor_glosa_med
    ...
    // PEGAR DADOS DO CAMPO DESCONTO
    // let input_desconto = document.getElementById("negociado_desconto_cap").value;
    // console.log(input_desconto);

    // negoc_desconto = inputDesc.value;
    // var negoc_desconto2 = finalMed;
